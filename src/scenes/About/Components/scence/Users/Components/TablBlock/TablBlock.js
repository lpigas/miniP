      ...
      {data.length ? (
        data.map((item) => (
          <tr key={item.name + item.id}>
            <td className="table__UsersData_datas table__UsersData_datasSmall">{item.id}</td>
            <td className="table__UsersData_datas table__UsersData_datasSmall">{item.name}</td>
            <td className="table__UsersData_datas table__UsersData_datasSmall">{item.username}</td>
            ...
            <td className="table__UsersData_datas table__UsersData_datasSmall">{item.website}</td>
            <td className="table__UsersData_datas">
